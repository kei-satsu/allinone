          ...
          <div className="bg-white/80 backdrop-blur-xl border border-gray-200/60 rounded-2xl shadow-2xl shadow-black/5 overflow-hidden relative">
            ...
            <div className="p-6 sm:p-8">
              <div className="flex flex-col items-center mb-8">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center shadow-lg shadow-orange-500/20 mb-4 rotate-3 hover:rotate-0 transition-transform duration-300 overflow-hidden">
  <img 
    src="/logo.png" // 👈 မိမိထည့်လိုသော ပုံလမ်းကြောင်း (သို့မဟုတ် image variable) ကို ဒီမှာထည့်ပါ
    alt="Logo" 
