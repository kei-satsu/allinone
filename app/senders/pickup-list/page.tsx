...
useEffect(() => {
  ...
  useEffect(() => {
    if (userBranch && selectedDate) {
      fetchSendersByDate(selectedDate, userBranch);
    }
  }, [selectedDate, userBranch]);

  // 🟢 ၂။ selectedSender ၊ Search သို့မဟုတ် Filter ပြောင်းပါက Table Data ပြန်ဆွဲထုတ်ခြင်း
  useEffect(() => {
  ...
  }, [selectedDate, selectedSender, globalSearch, userBranch, colFiltersKey]);
